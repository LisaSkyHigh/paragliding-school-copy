...
export NEXT_PUBLIC_BASE_PATH="/paragliding-school"
export NEXT_PUBLIC_SITE_URL="https://lisaskyhigh.github.io/paragliding-school"
npm run build
npx --yes gh-pages@6.1.1 -d out -b gh-pages -f -m "Deploy static site"
